...
from pyspark.sql.functions import col, from_json, from_unixtime, struct, to_json, udf, when
...
def main() -> None:
    ...
    enriched_postgres = (
        ...
        .option("checkpointLocation", "/opt/ghostnet/streaming/_checkpoints/postgres")
        .start()
    )
